...
__bpf_kfunc u32 bpf_tzcnt_u32(u32 val) { return __tzcnt_u32(val); }
EXPORT_SYMBOL_GPL(bpf_tzcnt_u32);

__bpf_kfunc u16 bpf_tzcnt_u16(u16 val) { return __tzcnt_u16(val); }
...
__bpf_kfunc uint32_t bpf_htss_sig_cmp(const void *sigs, size_t sigs__sz,
  ...
  __u32 hitmask = _mm256_movemask_epi8((__m256i)_mm256_cmpeq_epi16(
      _mm256_load_si256((__m256i const *)sigs), _mm256_set1_epi16(tmp_sig)));
  return hitmask;
}
