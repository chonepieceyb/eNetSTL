...
{                                                                               \
        ...
        return  (__idx1 << HBITMAP_LEVEL_1_SHIFT) + __ffs(hpiq->bitmap_lvl_2[__idx1]);                               \
}  
...
{                                                                                                   \
        ...
        return  (__idx1 << HBITMAP_LEVEL_2_SHIFT) + (__idx2 << HBITMAP_LEVEL_1_SHIFT) +  __ffs(hpiq->bitmap_lvl_3[__idx2]);        \
}   
