...
extern void bpf_hash_smid_cnt_u32(const struct pkt_5tuple *buf, 
		void *mem, u64 size__sz, u32 column_shift) __ksym;
...
{
	bpf_hash_smid_cnt_u32((struct pkt_5tuple *)element, (void*)cm, sizeof(*cm), 8);  //COLUNM_SHIT 8
}
