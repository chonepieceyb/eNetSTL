...
int xdp_main(struct xdp_md *ctx) 
{
        ...
        *(u64*)(&k) = vv;
        ...
        /*alloc and release a node for testing*/
        ...
        ptr_write_data1(newentry, offsetof(struct skip_node, key), &k, sizeof(k));
        ptr_write_data2(newentry, offsetof(struct skip_node, val), &lookup_res, sizeof(lookup_res));
        // /*set owner*/
